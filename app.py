...
normalized_age['Young'] = fuzz.gaussmf(x_age, mean=0.2, sigma=0.1)
normalized_age['Middle'] = fuzz.gaussmf(x_age, mean=0.5, sigma=0.1)
normalized_age['Old'] = fuzz.gaussmf(x_age, mean=0.8, sigma=0.1)
