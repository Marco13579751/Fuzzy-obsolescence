...
rules = [
    ...
    ctrl.Rule(normalized_age['New'] & normalized_fault_rate_levels['VeryLow'], criticity['VeryLow']),
    ctrl.Rule(normalized_age['Old'] & normalized_fault_rate_levels['VeryHigh'], criticity['VeryHigh']),
