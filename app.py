...
normalized_age['New'] = fuzz.gaussmf(normalized_age.universe, 0.2, 0.15)
normalized_age['Middle'] = fuzz.gaussmf(normalized_age.universe, 0.5, 0.15)
normalized_age['Old'] = fuzz.gaussmf(normalized_age.universe, 0.8, 0.15)
...
# Define fuzzy rules
rules = [
    ctrl.Rule(normalized_age['New'], criticity['VeryLow'],weigth=0.5),
    ctrl.Rule(normalized_age['Middle'], criticity['Medium'],weigth=0.5),
    ctrl.Rule(normalized_age['Old'], criticity['VeryHigh'],weigth=0.5),
    
    ctrl.Rule(normalized_fault_rate_levels['Under trh'], criticity['VeryLow'],weigth=0.5),
    ctrl.Rule(normalized_fault_rate_levels['Around trh'], criticity['Medium'],weigth=0.5),
    ctrl.Rule(normalized_fault_rate_levels['Above trh'], criticity['VeryHigh'],weigth=0.5),
